    ...
    <div className="space-y-12 pb-32 animate-in slide-in-from-bottom duration-700">
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="glass p-8 rounded-[3rem] border border-white/5 space-y-6 bg-gradient-to-br from-amber-500/5 to-transparent">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="h-10 w-10 bg-amber-600 rounded-xl flex items-center justify-center text-white"><GraduationCap size={20} /></div>
                <h5 className="text-sm font-black uppercase text-white">Enseignants</h5>
              </div>
              <div className="flex items-center gap-3">
                 <button title="Bilan Hebdomadaire" onClick={onOpenExportWeeklyTeacherAbsences} className="p-2 bg-indigo-600/20 text-indigo-500 rounded-xl hover:bg-indigo-600 hover:text-white transition-all shadow-sm border border-indigo-500/20 flex items-center gap-1">
                  <span className="text-[8px] font-black uppercase">Hebdo</span>
                  <FileDown size={14} />
                </button>
                <button title="Bilan Mensuel" onClick={onOpenExportTeacherAbsences} className="p-2 bg-amber-600/20 text-amber-500 rounded-xl hover:bg-amber-600 hover:text-white transition-all shadow-sm border border-amber-500/20 flex items-center gap-1">
                  <span className="text-[8px] font-black uppercase">Mensuel</span>
                  <FileDown size={14} />
                </button>
                <span className="text-2xl font-black text-amber-400">{stats.teachers.total}</span>
              </div>
            </div>
            <div className="bg-slate-900/50 p-5 rounded-2xl border border-white/5 flex items-center justify-between">
              <div>
                <p className="text-[8px] font-black text-slate-500 uppercase">Absences Actives</p>
                <p className="text-xl font-black text-white">{stats.teachers.absences} H</p>
              </div>
